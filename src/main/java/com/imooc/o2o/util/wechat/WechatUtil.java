...
public class WechatUtil {
    ...
    public static UserAccessToken getUserAccessToken(String code) throws IOException {
        // 测试号信息里的appId
        String appId = "wx5467a2f9f55fe3af";
        log.info("appId:" + appId);
        // 测试号信息里的appsecret
        String appsecret = "e5df9aa8f810361728dbba355be1b6fa";
        ...
        try {
            token = JSON.parseObject(tokenStr, UserAccessToken.class);
            // 将json字符串转换成相应对象
        } catch (Exception e) {
    ...
    public static WechatUser getUserInfo(String accessToken, String openId) {
        ...
        try {
            // 将json字符串转换成相应对象
            user = JSON.parseObject(userStr, WechatUser.class);
        } catch (Exception e) {
    ...
    /**
     * 将WechatUser 里的信息转换成 PersonInfo 的信息并返回 PersonInfo 实体类
     *
     * @param user
     * @return
     */
